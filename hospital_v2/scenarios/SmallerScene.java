...
public class SmallerScene extends Scenario {
    // 时间参数
    // 仿真时长，包括：预热期、统计期和收尾期
    ...
    public SmallerScene(int pal, float[] enr) {
    ...
    public void setUp() {
        ...
        Department CT = new Department("CT", 7);
        // CT的检查项目
        ...
        Department DR = new Department("DR", 5);
        // 检查包
        ...
        Department MR = new Department("MR", 5);
        // 检查包
        ...
        Department US = new Department("US", 7);
        // 检查包
        ...
        Department UC = new Department("UC", 3);
        // 检查包
        ...
        Department ES = new Department("ES", 3);
        // 检查包
