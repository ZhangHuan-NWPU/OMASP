...
public class LargerSurrogateScene extends SurrogateScene {
    // 时间参数
    // 仿真时长，包括：预热期、统计期和收尾期
    ...
    public LargerSurrogateScene(int pal, float[] enr) {
        super(pal, enr);
    ...
    public void setUp() {
        ...
        Department CT = new Department("CT", 6);
        // CT的检查项目
        ...
        Department DR = new Department("DR", 4);
        // 检查包
        ...
        Department MR = new Department("MR", 4);
        // 检查包
        ...
        Department US = new Department("US", 6);
        // 检查包
        ...
        Department UC = new Department("UC", 2);
        // 检查包
        ...
        Department ES = new Department("ES", 2);
        // 检查包
