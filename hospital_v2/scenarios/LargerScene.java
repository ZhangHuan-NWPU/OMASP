...
public class LargerScene extends StandardScene {
    // 时间参数
    // 仿真时长，包括：预热期、统计期和收尾期
    ...
    public LargerScene(int pal, float[] enr) {
        super(pal, enr);
    ...
    public void setUp() {
        ...
        Department CT = new Department("CT", 30);
        // CT的检查项目
        ...
        Machine M_CT16 = new Machine("M_CT16", CT, 1.0F);
        Machine M_CT17 = new Machine("M_CT17", CT, 1.0F);
        Machine M_CT18 = new Machine("M_CT18", CT, 1.0F);
        Machine M_CT19 = new Machine("M_CT19", CT, 1.0F);
        Machine M_CT20 = new Machine("M_CT20", CT, 1.0F);
        Machine M_CT21 = new Machine("M_CT21", CT, 1.0F);
        Machine M_CT22 = new Machine("M_CT22", CT, 1.0F);
        Machine M_CT23 = new Machine("M_CT23", CT, 1.0F);
        Machine M_CT24 = new Machine("M_CT24", CT, 1.0F);
        Machine M_CT25 = new Machine("M_CT25", CT, 1.0F);
        Machine M_CT26 = new Machine("M_CT26", CT, 1.0F);
        Machine M_CT27 = new Machine("M_CT27", CT, 1.0F);
        Machine M_CT28 = new Machine("M_CT28", CT, 1.0F);
        Machine M_CT29 = new Machine("M_CT29", CT, 1.0F);
        Machine M_CT30 = new Machine("M_CT30", CT, 1.0F);
        ...
        M_CT16.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT16.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT17.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT17.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT18.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT18.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT19.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT19.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT20.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT20.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT21.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT21.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT22.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT22.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT23.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT23.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT24.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT24.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT25.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT25.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT26.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT26.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT27.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT27.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT28.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT28.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT29.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT29.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        M_CT30.setWeekdayPlan(3, ids1, sts1, ets1, sizes1);
        M_CT30.setWeekendPlan(2, ids2, sts2, ets2, sizes2);
        ...
        CT.addMachine(M_CT16);
        CT.addMachine(M_CT17);
        CT.addMachine(M_CT18);
        CT.addMachine(M_CT19);
        CT.addMachine(M_CT20);
        CT.addMachine(M_CT21);
        CT.addMachine(M_CT22);
        CT.addMachine(M_CT23);
        CT.addMachine(M_CT24);
        CT.addMachine(M_CT25);
        CT.addMachine(M_CT26);
        CT.addMachine(M_CT27);
        CT.addMachine(M_CT28);
        CT.addMachine(M_CT29);
        CT.addMachine(M_CT30);
        // 添加科室
        new_dept_list.add(CT);

        // 科室2：DR，包括5台机器与4种检查项目
        Department DR = new Department("DR", 20);
        // 检查包
        ...
        Machine M_DR11 = new Machine("M_DR11", DR, 1.315F);
        Machine M_DR12 = new Machine("M_DR12", DR, 1.315F);
        Machine M_DR13 = new Machine("M_DR13", DR, 1.315F);
        Machine M_DR14 = new Machine("M_DR14", DR, 1.315F);
        Machine M_DR15 = new Machine("M_DR15", DR, 1.315F);
        Machine M_DR16 = new Machine("M_DR16", DR, 1.315F);
        Machine M_DR17 = new Machine("M_DR17", DR, 1.315F);
        Machine M_DR18 = new Machine("M_DR18", DR, 1.315F);
        Machine M_DR19 = new Machine("M_DR19", DR, 1.315F);
        Machine M_DR20 = new Machine("M_DR20", DR, 1.315F);
        // 计划
        int[] ids3 = {2, 3, 5};
        ...
        M_DR11.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR11.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR12.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR12.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR13.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR13.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR14.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR14.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR15.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR15.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR16.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR16.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR17.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR17.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR18.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR18.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR19.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR19.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        M_DR20.setWeekdayPlan(3, ids3, sts3, ets3, sizes3);
        M_DR20.setWeekendPlan(2, ids4, sts4, ets4, sizes4);
        // 添加机器
        ...
        DR.addMachine(M_DR11);
        DR.addMachine(M_DR12);
        DR.addMachine(M_DR13);
        DR.addMachine(M_DR14);
        DR.addMachine(M_DR15);
        DR.addMachine(M_DR16);
        DR.addMachine(M_DR17);
        DR.addMachine(M_DR18);
        DR.addMachine(M_DR19);
        DR.addMachine(M_DR20);
        // 添加科室
        new_dept_list.add(DR);

        // 科室3：MR，包括10台机器与3种检查项目
        Department MR = new Department("MR", 20);
        // 检查包
        ...
        Machine M_MR11 = new Machine("M_MR11", MR, 2.311F);
        Machine M_MR12 = new Machine("M_MR12", MR, 2.311F);
        Machine M_MR13 = new Machine("M_MR13", MR, 2.311F);
        Machine M_MR14 = new Machine("M_MR14", MR, 2.311F);
        Machine M_MR15 = new Machine("M_MR15", MR, 2.311F);
        Machine M_MR16 = new Machine("M_MR16", MR, 2.311F);
        Machine M_MR17 = new Machine("M_MR17", MR, 2.311F);
        Machine M_MR18 = new Machine("M_MR18", MR, 2.311F);
        Machine M_MR19 = new Machine("M_MR19", MR, 2.311F);
        Machine M_MR20 = new Machine("M_MR20", MR, 2.311F);
        ...
        M_MR11.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR11.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR12.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR12.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR13.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR13.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR14.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR14.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR15.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR15.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR16.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR16.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR17.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR17.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR18.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR18.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR19.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR19.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        M_MR20.setWeekdayPlan(3, ids5, sts5, ets5, sizes5);
        M_MR20.setWeekendPlan(2, ids6, sts6, ets6, sizes6);
        ...
        MR.addMachine(M_MR11);
        MR.addMachine(M_MR12);
        MR.addMachine(M_MR13);
        MR.addMachine(M_MR14);
        MR.addMachine(M_MR15);
        MR.addMachine(M_MR16);
        MR.addMachine(M_MR17);
        MR.addMachine(M_MR18);
        MR.addMachine(M_MR19);
        MR.addMachine(M_MR20);

        // 添加科室
        new_dept_list.add(MR);

        // 科室4：US，包括20台机器与4种检查项目
        Department US = new Department("US", 30);
        // 检查包
        ...
        Machine M_US16 = new Machine("M_US16", US, 1.618F);
        Machine M_US17 = new Machine("M_US17", US, 1.618F);
        Machine M_US18 = new Machine("M_US18", US, 1.618F);
        Machine M_US19 = new Machine("M_US19", US, 1.618F);
        Machine M_US20 = new Machine("M_US20", US, 1.618F);
        Machine M_US21 = new Machine("M_US21", US, 1.618F);
        Machine M_US22 = new Machine("M_US22", US, 1.618F);
        Machine M_US23 = new Machine("M_US23", US, 1.618F);
        Machine M_US24 = new Machine("M_US24", US, 1.618F);
        Machine M_US25 = new Machine("M_US25", US, 1.618F);
        Machine M_US26 = new Machine("M_US26", US, 1.618F);
        Machine M_US27 = new Machine("M_US27", US, 1.618F);
        Machine M_US28 = new Machine("M_US28", US, 1.618F);
        Machine M_US29 = new Machine("M_US29", US, 1.618F);
        Machine M_US30 = new Machine("M_US30", US, 1.618F);
        ...
        M_US16.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US16.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US17.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US17.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US18.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US18.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US19.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US19.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US20.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US20.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US21.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US21.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US22.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US22.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US23.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US23.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US24.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US24.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US25.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US25.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US26.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US26.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US27.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US27.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US28.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US28.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US29.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US29.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        M_US30.setWeekdayPlan(5, ids7, sts7, ets7, sizes7);
        M_US30.setWeekendPlan(2, ids8, sts8, ets8, sizes8);
        ...
        US.addMachine(M_US16);
        US.addMachine(M_US17);
        US.addMachine(M_US18);
        US.addMachine(M_US19);
        US.addMachine(M_US20);
        US.addMachine(M_US21);
        US.addMachine(M_US22);
        US.addMachine(M_US23);
        US.addMachine(M_US24);
        US.addMachine(M_US25);
        US.addMachine(M_US26);
        US.addMachine(M_US27);
        US.addMachine(M_US28);
        US.addMachine(M_US29);
        US.addMachine(M_US30);

        // 添加科室
        new_dept_list.add(US);

        // 科室5：UC，包括5台机器与1种检查项目
        Department UC = new Department("UC", 10);
        // 检查包
        ...
        Machine M_UC06 = new Machine("M_UC06", UC, 1.0F);
        Machine M_UC07 = new Machine("M_UC07", UC, 1.0F);
        Machine M_UC08 = new Machine("M_UC08", UC, 1.0F);
        Machine M_UC09 = new Machine("M_UC09", UC, 1.0F);
        Machine M_UC10 = new Machine("M_UC10", UC, 1.0F);
        ...
        M_UC06.setWeekdayPlan(3, ids9, sts9, ets9, sizes9);
        M_UC06.setWeekendPlan(2, ids10, sts10, ets10, sizes10);
        M_UC07.setWeekdayPlan(3, ids9, sts9, ets9, sizes9);
        M_UC07.setWeekendPlan(2, ids10, sts10, ets10, sizes10);
        M_UC08.setWeekdayPlan(3, ids9, sts9, ets9, sizes9);
        M_UC08.setWeekendPlan(2, ids10, sts10, ets10, sizes10);
        M_UC09.setWeekdayPlan(3, ids9, sts9, ets9, sizes9);
        M_UC09.setWeekendPlan(2, ids10, sts10, ets10, sizes10);
        M_UC10.setWeekdayPlan(3, ids9, sts9, ets9, sizes9);
        M_UC10.setWeekendPlan(2, ids10, sts10, ets10, sizes10);
        ...
        UC.addMachine(M_UC06);
        UC.addMachine(M_UC07);
        UC.addMachine(M_UC08);
        UC.addMachine(M_UC09);
        UC.addMachine(M_UC10);

        // 添加科室
        new_dept_list.add(UC);

        // 科室6：ES，包括5台机器与3种检查项目
        Department ES = new Department("ES", 10);
        // 检查包
        ...
        Machine M_ES06 = new Machine("M_ES06", ES, 1.398F);
        Machine M_ES07 = new Machine("M_ES07", ES, 1.398F);
        Machine M_ES08 = new Machine("M_ES08", ES, 1.398F);
        Machine M_ES09 = new Machine("M_ES09", ES, 1.398F);
        Machine M_ES10 = new Machine("M_ES10", ES, 1.398F);
        ...
        M_ES06.setWeekdayPlan(4, ids11, sts11, ets11, sizes11);
        M_ES06.setWeekendPlan(1, ids12, sts12, ets12, sizes12);
        M_ES07.setWeekdayPlan(4, ids11, sts11, ets11, sizes11);
        M_ES07.setWeekendPlan(1, ids12, sts12, ets12, sizes12);
        M_ES08.setWeekdayPlan(4, ids11, sts11, ets11, sizes11);
        M_ES08.setWeekendPlan(1, ids12, sts12, ets12, sizes12);
        M_ES09.setWeekdayPlan(4, ids11, sts11, ets11, sizes11);
        M_ES09.setWeekendPlan(1, ids12, sts12, ets12, sizes12);
        M_ES10.setWeekdayPlan(4, ids11, sts11, ets11, sizes11);
        M_ES10.setWeekendPlan(1, ids12, sts12, ets12, sizes12);
        ...
        ES.addMachine(M_ES06);
        ES.addMachine(M_ES07);
        ES.addMachine(M_ES08);
        ES.addMachine(M_ES09);
        ES.addMachine(M_ES10);
        // 添加科室
