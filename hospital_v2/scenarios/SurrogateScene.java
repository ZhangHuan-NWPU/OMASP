...
public class SurrogateScene extends Scenario {
    // 时间参数
    // 仿真时长，包括：预热期、统计期和收尾期
    ...
    public SurrogateScene(int pal, float[] enr) {
    ...
    public void setUp() {
        ...
        Department CT = new Department("CT", 3);
        // CT的检查项目
        ...
        Department DR = new Department("DR", 2);
        // 检查包
        ...
        Department MR = new Department("MR", 2);
        // 检查包
        ...
        Department US = new Department("US", 3);
        // 检查包
        ...
        Department ES = new Department("ES", 1);
        // 检查包
